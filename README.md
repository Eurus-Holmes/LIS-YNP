...
Of course, anything on github has its own "Awesome". The [Awesome-pytorch-list](https://github.com/bharathgs/Awesome-pytorch-list) collected different models, implementations, helper libraries, tutorials etc.
